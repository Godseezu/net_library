//package lc.com.net_library.rmi;
//
...
//import lc.com.net_library.tcpudp.KryoNetException;
//import lc.com.net_library.tcpudp.Listener;
//import lc.com.net_library.util.ObjectIntMap;
//
///** Allows methods on objects to be invoked remotely over TCP or UDP. Objects are { #register(int, Object) registered} with an
// * ID. The remote end of connections that have been { #addConnection(Connection) added} are allowed to
// * { #getRemoteObject(Connection, int, Class) access} registered objects.
// * <p>
...
//		public void received (final Connection connection, byte[] data) {
...
//	};
//
//	/** Creates an ObjectSpace with no connections. Connections must be {#addConnection(Connection) added} to allow the remote
...
//	 * request. This method is invoked on the update thread of the { EndPoint} for this ObjectSpace and unless an
